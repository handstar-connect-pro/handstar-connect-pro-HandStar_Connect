 ...
 */
final class Version20251227205556 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach DROP photo, DROP gender, DROP birth_date, DROP certifications, DROP division, DROP nationality, DROP address, DROP postal_code, DROP city, DROP region, DROP phone, DROP is_profile_public, DROP profil, DROP user_id');
    }
}
