...
use App\Enums\DiplomaPhysicalTrainer;
use App\Enums\ListRegion;
use App\Enums\PersonGender;
use App\Enums\UserProfil;
use App\Repository\PhysicalTrainerRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\UX\Turbo\Attribute\Broadcast;

#[ORM\Entity(repositoryClass: PhysicalTrainerRepository::class)]
#[Broadcast]
class PhysicalTrainer
{
    ...
    #[ORM\Column(length: 50, enumType: DiplomaPhysicalTrainer::class)]
    private ?DiplomaPhysicalTrainer $certifications = null;
    ...
    public function getCertifications(): ?DiplomaPhysicalTrainer
    {
        return $this->certifications;
    }

    public function setCertifications(DiplomaPhysicalTrainer $certifications): static
    {
