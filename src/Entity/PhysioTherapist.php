...
use App\Enums\DiplomaPhysioTherapist;
use App\Enums\LevelDivision;
use App\Enums\ListRegion;
use App\Enums\PersonGender;
use App\Enums\UserProfil;
use App\Repository\PhysioTherapistRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\UX\Turbo\Attribute\Broadcast;

#[ORM\Entity(repositoryClass: PhysioTherapistRepository::class)]
#[Broadcast]
class PhysioTherapist
{
    ...
    #[ORM\Column(length: 50, enumType: DiplomaPhysioTherapist::class)]
    private ?DiplomaPhysioTherapist $certifications = null;
    ...
    public function getCertifications(): ?DiplomaPhysioTherapist
    {
        return $this->certifications;
    }

    public function setCertifications(DiplomaPhysioTherapist $certifications): static
    {
