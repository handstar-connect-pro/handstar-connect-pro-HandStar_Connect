...
use App\Enums\DiplomaVideoAnalyst;
use App\Enums\LevelDivision;
use App\Enums\ListRegion;
use App\Enums\PersonGender;
use App\Enums\UserProfil;
use App\Repository\VideoAnalystRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\UX\Turbo\Attribute\Broadcast;

#[ORM\Entity(repositoryClass: VideoAnalystRepository::class)]
#[Broadcast]
class VideoAnalyst
{
    #[ORM\Id]
    ...
    #[ORM\Column(length: 50, enumType: DiplomaVideoAnalyst::class)]
    private ?DiplomaVideoAnalyst $certifications = null;
    ...
    public function getCertifications(): ?DiplomaVideoAnalyst
    {
        return $this->certifications;
    }

    public function setCertifications(DiplomaVideoAnalyst $certifications): static
    {
