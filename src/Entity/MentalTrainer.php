...
use App\Enums\DiplomaMentalTrainer;
use App\Enums\LevelDivision;
use App\Enums\ListRegion;
use App\Enums\PersonGender;
use App\Enums\UserProfil;
use App\Repository\MentalTrainerRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\UX\Turbo\Attribute\Broadcast;

#[ORM\Entity(repositoryClass: MentalTrainerRepository::class)]
#[Broadcast]
class MentalTrainer
{
    #[ORM\Id]
    ...
    #[ORM\Column(length: 50, enumType: DiplomaMentalTrainer::class)]
    private ?DiplomaMentalTrainer $certifications = null;
    ...
    public function getCertifications(): ?DiplomaMentalTrainer
    {
        return $this->certifications;
    }

    public function setCertifications(DiplomaMentalTrainer $certifications): static
    {
