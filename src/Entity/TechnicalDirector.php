...
use App\Enums\DiplomaCoach;
use App\Enums\LevelDivision;
use App\Enums\ListRegion;
use App\Enums\PersonGender;
use App\Enums\UserProfil;
use App\Repository\TechnicalDirectorRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;
use Symfony\UX\Turbo\Attribute\Broadcast;

#[ORM\Entity(repositoryClass: TechnicalDirectorRepository::class)]
#[Broadcast]
class TechnicalDirector
{
    ...
    #[ORM\Column(length: 50, enumType: DiplomaCoach::class)]
    private ?DiplomaCoach $certifications = null;
    ...
    public function getCertifications(): ?DiplomaCoach
    {
        return $this->certifications;
    }

    public function setCertifications(DiplomaCoach $certifications): static
    {
