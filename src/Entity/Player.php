...
class Player
{
    ...
    #[ORM\Column(length: 20, enumType: PlayerLaterality::class)]
    private ?PlayerLaterality $handedness = null;

    #[ORM\Column(length: 20, enumType: PlayerPosition::class)]
    private ?PlayerPosition $gamePosition = null;

    #[ORM\ManyToOne(targetEntity: Club::class)]
    #[ORM\JoinColumn(name: 'current_club_id', referencedColumnName: 'id', nullable: true)]
    ...
    public function getHandedness(): ?PlayerLaterality
    {
        return $this->handedness;
    }

    public function setHandedness(PlayerLaterality $handedness): static
    {
    ...
    public function getGamePosition(): ?PlayerPosition
    {
        return $this->gamePosition;
    }

    public function setGamePosition(PlayerPosition $gamePosition): static
    {
