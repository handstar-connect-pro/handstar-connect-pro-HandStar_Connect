...
class TechnicalDirectorUserCrudController extends BaseFilteredCrudController
{
    protected function getProfilFilter(): UserProfil
    {
        return UserProfil::TECHNICAL_DIRECTOR;
    }

    protected function getPageTitle(): string
    {
        return 'Directeurs Techniques';
    }
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ChoiceField::new('profil', 'Profil')
                ->setChoices([
                    UserProfil::TECHNICAL_DIRECTOR->getLabel() => UserProfil::TECHNICAL_DIRECTOR
                ])
